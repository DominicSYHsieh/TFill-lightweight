...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        self.params_name = os.path.join(opt.checkpoints_dir, opt.name, 'params.txt')
        try:
            os.remove(self.params_name)
    ...
    def print_current_losses(self, epoch, iters, losses, t_comp, t_data, total_time, avg_forward_time, avg_backward_time):
        ...
        """
        message = 'epoch: %d, iters: %d, time: %.3f s, data: %.3f, total_time: %.3f s, avg_forward_time: %.3f s, avg_backward_time: %.3f s ' % (epoch, iters, t_comp, t_data, total_time, avg_forward_time,avg_backward_time)
    ...
    #edit
    def save_model_params(self,message):
        with open(self.params_name, "a") as params_file:
            params_file.write('%s\n' % message)
