...
if __name__ == '__main__':
    ...
    model_names=['netT','netE','netG','netD']
    model_params = [model.calc_parameter(n) for n in model_names]
    visualizer = Visualizer(opt)  # create a visualizer
    [visualizer.save_model_params(p) for p in model_params]
    ...
    while (total_iters < max_iteration):
        ...
        for i, data in enumerate(dataset):
            ...
            #edit
            avg_forward_time,avg_backward_time=model.optimize_parameters()
            ...
            if total_iters % opt.print_freq == 0:  # print training losses and save logging information to the disk
                ...
                visualizer.print_current_losses(epoch, total_iters, losses, t_comp, t_data, total_time, avg_forward_time, avg_backward_time)
