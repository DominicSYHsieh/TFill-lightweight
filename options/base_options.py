...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # data define
        parser.add_argument('--mask_type', type=int, default=[0,1,2], help='0:center,1:regular,2:irregular,3:external')
        ...
        parser.add_argument('--nThreads', type=int, default=16, help='# threads for loading data')
